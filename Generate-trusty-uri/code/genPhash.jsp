...
<div class="col-sm-2 sidenav">
  ...
  <script>
    var bits = 16;
	var file='<%=request.getParameter("path")%>';
...
%>
<form action="phashU.jsp" method="post">
<input type="text" name="path" value="<%=path%>" readonly="readonly"/><br/>
<input type="text" name="hash" id="hash" readonly="readonly"/><br/>
