...
<%
      try{
            final String fromEmail = "annubannu101@gmail.com"; //requires valid gmail id
            final String password = "ANVESH143!"; // correct password for gmail id
            final String toEmail = request.getParameter("email"); // can be any email id 
            ...
            message.setSubject("File status");
            message.setText("Hello! "+owner+" \n\n your File "+file+" has been attacked. \n\n To replace file with original \n\n Click here : http://192.168.0.6:8080/pro/repImage.jsp?file="+file+"&hash=k");
