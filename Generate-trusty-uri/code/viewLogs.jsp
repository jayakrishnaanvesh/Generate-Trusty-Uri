...
<div class="col-sm-2 sidenav">
          ...
          <h2><span>All <span class="style8">End Users </span>And <span class="style8">Data Owner</span> Transactions... </span></h2>
          <div class="clr"></div>
          
       
          <div class="clr"></div>
          <p>
  <table class="table-condensed table-hover" width="626" border="1" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="115" height="31">User Name </td>
 ...
 <%@ page import="java.sql.*" %>
  ...
  <tr>
     <td height="29"><div align="center" class="style9"><%=s2%></div></td>
     <td><div align="center" class="style9"><%=s3%></div></td>
     <td><div align="center" class="style9"><%=s4%></div></td>
