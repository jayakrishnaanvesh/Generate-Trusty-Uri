...
%>
<TABLE class="table-hover table-condensed" border="1">
<tr>
<td>File</td>
<td>image</td>
<td>Original hash</td>
...
PreparedStatement psmnt = connection.prepareStatement("select * from file1 where owner=?");
psmnt.setString(1,owner);
ResultSet rs=psmnt.executeQuery();
while(rs.next()){
 %>
  <tr>
<form action="repImage.jsp">
 <td><input type="text" name="file" value=<%=rs.getString(4)%>>
 <td><img src="/pro/img/<%=rs.getString(4)%>"/>
 <td><input type="text" name="hash" value=<%=rs.getString(3)%>>
