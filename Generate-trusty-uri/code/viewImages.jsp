...
<div class="col-sm-2 sidenav">
	  ...
	  <table border=1 class="table-condensed table-hover" width=5>
	  <tr>
	  <td>Image name</td>
	  <td>owner</td>
	  <td>Link</td>
	...
	Class.forName("com.mysql.jdbc.Driver");
      	...
      	try 
	{
            PreparedStatement p=connection.prepareStatement("select * from reqimg where user=? and status='yes'"); 
            p.setString(1,s3);		
			...
			%>
				...
				<td><%=file%></td>
				<td><%=owner%></td>
				<td><a href="img.jsp?src=<%=file%>">Click here</a></td>
				<td>yes</td>
				</tr>
				<%
			}
