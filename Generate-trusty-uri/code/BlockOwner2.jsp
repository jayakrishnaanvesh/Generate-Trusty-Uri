...
PreparedStatement psmnt = connection.prepareStatement("delete from atkd where atkr=? and ip=?");
psmnt.setString(1,request.getParameter("atkr"));
psmnt.setString(2,request.getParameter("ip"));
psmnt.executeUpdate();
PreparedStatement pr = connection.prepareStatement("delete from atkimg1 where atkr=? and ip=?");
pr.setString(1,request.getParameter("atkr"));
pr.setString(2,request.getParameter("ip"));
pr.executeUpdate();
PreparedStatement ps = connection.prepareStatement("insert into btable values(?,?)");
ps.setString(1,request.getParameter("atkr"));
ps.setString(2,request.getParameter("ip"));
ps.executeUpdate();
PreparedStatement p = connection.prepareStatement("update owner set status='blocked' where username=?");
p.setString(1,request.getParameter("atkr"));
p.executeUpdate();
%>
