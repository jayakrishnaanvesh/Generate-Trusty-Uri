...
<div class="col-sm-2 sidenav">
            ...
            <li><a href="ownerPermission.jsp">Grant Permission( text Files)</a></li>
			 <li><a href="imagePermission.jsp">Image Permission</a></li>
            <li><a href="viewOwnerFiles.jsp">View Files</a></li>
            <li><a href="upImage.jsp">Upload Images</a></li>
			<li><a href="editFile.jsp">Edit Files</a></li>
			<li><a href="Mverify.jsp">Verify Manually(text)</a></li>
			<li><a href="imgverify.jsp">Verify Manually(img)</a></li>
			<li><a href="imgReplace.jsp">Replace Image</a></li>
            <li><a href="dataOwnerLogin.html">Log Out</a></li>
       
          </ul>
        </div>
       <h2><span>WelCome To Data Owner<span class="style1"> <%=(String)application.getAttribute("owner")%></span></span></h2>
          <center><img src="owner.png"></center>
		  <p>
		</p>
