...
input[type=password], select {
  ...
  <div class="container text-center">
	...
	Class.forName("com.mysql.jdbc.Driver");
      	...
      	try 
	{
            PreparedStatement p=connection.prepareStatement("select * from request where dataowner=? and file=? and user=? "); 
            p.setString(1,s2);
            p.setString(2,s1);
            p.setString(3,s3);			
