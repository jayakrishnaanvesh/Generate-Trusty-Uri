...
PreparedStatement psmnt = connection.prepareStatement("delete from btable where atkr=? and ip=?");
psmnt.setString(1,request.getParameter("atkr"));
psmnt.setString(2,request.getParameter("ip"));
psmnt.executeUpdate();
PreparedStatement ps = connection.prepareStatement("update owner set status='Authorized' where username=?");
ps.setString(1,request.getParameter("atkr"));
ps.executeUpdate();
%>
<h2>UnBlocked successfully</h2>
<%
}
catch(Exception e){
   out.println(e);
