...
<div class="col-sm-2 sidenav">
            ...
            <li><a href="viewAllDataOwners.jsp">View All Data Owners</a></li>
            <li><a href="viewAllFiles.jsp">View All Owner Files</a></li>
            <li><a href="BlockOwner.jsp">Block Owner</a></li>
			<li><a href="unBlock.jsp">Unblock</a></li>
			 <li><a href="attackedFiles.jsp">Attacked Files</a></li>
			<li><a href="viewLogs.jsp">View Transactions</a></li>
			<li><a href="webServerLogin.html">Log Out</a></li>
          </ul>
        </div>
