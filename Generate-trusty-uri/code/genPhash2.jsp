...
%>
<form action="phashU2.jsp" method="post">
File:<input type="text" name="path" value="<%=path%>" readonly="readonly"/><br/>
Hash<input type="text" name="hash" id="hash" readonly="readonly"/><br/>
