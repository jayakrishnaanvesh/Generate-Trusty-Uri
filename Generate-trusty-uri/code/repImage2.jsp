...
//out.println(saveFile+" "+parts[0]);
parts[0]=parts[0].substring(0,parts[0].length()-3);
//out.println(saveFile+" "+parts[0]);
if(saveFile.equals(parts[0])){
String path="C:/Tomcat 9.0/webapps/pro/img/"+saveFile;
...
<a href="genPhash2.jsp?path=<%=saveFile%>">Generate hash</a>
<%
}
catch(Exception e){
   out.println(e);
	...
	%>
	filename of image should be same 
	<%
}
}
%>
